...
def main():
    ...
    if dashboard_fig:
        plot(
            dashboard_fig,
            filename="visualization/visualization_output/cfd_interactive_dashboard.html",
            auto_open=True,
        )
        print(
            "Interactive dashboard saved as 'visualization/visualization_output/cfd_interactive_dashboard.html'"
        )
    ...
    if analysis_fig:
        plot(
            analysis_fig,
            filename="visualization/visualization_output/cfd_flow_analysis.html",
            auto_open=True,
        )
        print(
            "Flow analysis dashboard saved as 'visualization/visualization_output/cfd_flow_analysis.html'"
        )
